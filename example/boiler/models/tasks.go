...
type Task struct {
	...
	ChildID   null.Int64 `boil:"child_id" json:"child_id,omitempty" toml:"child_id" yaml:"child_id,omitempty"`
	Title     string     `boil:"title" json:"title" toml:"title" yaml:"title"`
	Note      string     `boil:"note" json:"note" toml:"note" yaml:"note"`
	Status    TaskStatus `boil:"status" json:"status" toml:"status" yaml:"status"`
...
type whereHelperTaskStatus struct{ field string }

func (w whereHelperTaskStatus) EQ(x TaskStatus) qm.QueryMod {
	return qmhelper.Where(w.field, qmhelper.EQ, x)
}
func (w whereHelperTaskStatus) NEQ(x TaskStatus) qm.QueryMod {
	return qmhelper.Where(w.field, qmhelper.NEQ, x)
}
func (w whereHelperTaskStatus) LT(x TaskStatus) qm.QueryMod {
	return qmhelper.Where(w.field, qmhelper.LT, x)
}
func (w whereHelperTaskStatus) LTE(x TaskStatus) qm.QueryMod {
	return qmhelper.Where(w.field, qmhelper.LTE, x)
}
func (w whereHelperTaskStatus) GT(x TaskStatus) qm.QueryMod {
	return qmhelper.Where(w.field, qmhelper.GT, x)
}
func (w whereHelperTaskStatus) GTE(x TaskStatus) qm.QueryMod {
	return qmhelper.Where(w.field, qmhelper.GTE, x)
}
...
var TaskWhere = struct {
	...
	ChildID   whereHelpernull_Int64
	Title     whereHelperstring
	Note      whereHelperstring
	Status    whereHelperTaskStatus
	UpdatedAt whereHelpertime_Time
	CreatedAt whereHelpertime_Time
}{
	ID:        whereHelperint64{field: "\"tasks\".\"id\""},
	UserID:    whereHelpernull_Int64{field: "\"tasks\".\"user_id\""},
	ChildID:   whereHelpernull_Int64{field: "\"tasks\".\"child_id\""},
	Title:     whereHelperstring{field: "\"tasks\".\"title\""},
	Note:      whereHelperstring{field: "\"tasks\".\"note\""},
	Status:    whereHelperTaskStatus{field: "\"tasks\".\"status\""},
...
type taskR struct {
	Child        *Task            `boil:"Child" json:"Child" toml:"Child" yaml:"Child"`
	User         *User            `boil:"User" json:"User" toml:"User" yaml:"User"`
	ProjectTasks ProjectTaskSlice `boil:"ProjectTasks" json:"ProjectTasks" toml:"ProjectTasks" yaml:"ProjectTasks"`
	ChildTasks   TaskSlice        `boil:"ChildTasks" json:"ChildTasks" toml:"ChildTasks" yaml:"ChildTasks"`
}
...
func (r *taskR) GetProjectTasks() ProjectTaskSlice {
	if r == nil {
		return nil
	}
...
func (r *taskR) GetChildTasks() TaskSlice {
	if r == nil {
		return nil
	}
	return r.ChildTasks
...
var (
	taskAllColumns            = []string{"id", "user_id", "child_id", "title", "note", "status", "updated_at", "created_at"}
	taskColumnsWithoutDefault = []string{"title", "note", "status"}
	taskColumnsWithDefault    = []string{"id", "user_id", "child_id", "updated_at", "created_at"}
...
func (o *Task) Child(mods ...qm.QueryMod) taskQuery {
...
func (o *Task) ProjectTasks(mods ...qm.QueryMod) projectTaskQuery {
	...
	queryMods = append(queryMods,
		qm.Where("\"project_tasks\".\"task_id\"=?", o.ID),
	)

	return ProjectTasks(queryMods...)
}

// ChildTasks retrieves all the task's Tasks with an executor via child_id column.
func (o *Task) ChildTasks(mods ...qm.QueryMod) taskQuery {
	var queryMods []qm.QueryMod
	if len(mods) != 0 {
		queryMods = append(queryMods, mods...)
	}
...
func (taskL) LoadChild(ctx context.Context, e boil.ContextExecutor, singular bool, maybeTask interface{}, mods queries.Applicator) error {
	var slice []*Task
	var object *Task
	...
	if singular {
		...
		if !queries.IsNil(object.ChildID) {
	...
	Outer:
		for _, obj := range slice {
			...
			for _, a := range args {
				if queries.Equal(a, obj.ChildID) {
					continue Outer
				}
			}

			if !queries.IsNil(obj.ChildID) {
	...
	if singular {
		...
		foreign.R.ChildTasks = append(foreign.R.ChildTasks, object)
		return nil
	}

	for _, local := range slice {
		for _, foreign := range resultSlice {
			if queries.Equal(local.ChildID, foreign.ID) {
				local.R.Child = foreign
				if foreign.R == nil {
					foreign.R = &taskR{}
				}
				foreign.R.ChildTasks = append(foreign.R.ChildTasks, local)
				break
			}
		}
	}
...
func (taskL) LoadProjectTasks(ctx context.Context, e boil.ContextExecutor, singular bool, maybeTask interface{}, mods queries.Applicator) error {
	var slice []*Task
	var object *Task
	...
	query := NewQuery(
		...
		qm.WhereIn(`project_tasks.task_id in ?`, args...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
// LoadChildTasks allows an eager lookup of values, cached into the
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (taskL) LoadChildTasks(ctx context.Context, e boil.ContextExecutor, singular bool, maybeTask interface{}, mods queries.Applicator) error {
	var slice []*Task
	var object *Task
	...
	query := NewQuery(
		qm.From(`tasks`),
		qm.WhereIn(`tasks.child_id in ?`, args...),
	)
	if mods != nil {
		mods.Apply(query)
	}
	...
	if singular {
		object.R.ChildTasks = resultSlice
		for _, foreign := range resultSlice {
			if foreign.R == nil {
				foreign.R = &taskR{}
			}
	...
	for _, foreign := range resultSlice {
		for _, local := range slice {
			if queries.Equal(local.ID, foreign.ChildID) {
				local.R.ChildTasks = append(local.R.ChildTasks, foreign)
				if foreign.R == nil {
					foreign.R = &taskR{}
				}
...
// SetChild of the task to the related item.
// Sets o.R.Child to related.
// Adds o to related.R.ChildTasks.
func (o *Task) SetChild(ctx context.Context, exec boil.ContextExecutor, insert bool, related *Task) error {
	var err error
	if insert {
	...
	queries.Assign(&o.ChildID, related.ID)
	if o.R == nil {
		o.R = &taskR{
			Child: related,
		}
	...
	if related.R == nil {
		related.R = &taskR{
			ChildTasks: TaskSlice{o},
		}
	} else {
		related.R.ChildTasks = append(related.R.ChildTasks, o)
	}
...
func (o *Task) RemoveChild(ctx context.Context, exec boil.ContextExecutor, related *Task) error {
	var err error

	queries.SetScanner(&o.ChildID, nil)
	if _, err = o.Update(ctx, exec, boil.Whitelist("child_id")); err != nil {
		return errors.Wrap(err, "failed to update local table")
	}
	...
	for i, ri := range related.R.ChildTasks {
		if queries.Equal(o.ChildID, ri.ChildID) {
			continue
		}

		ln := len(related.R.ChildTasks)
		if ln > 1 && i < ln-1 {
			related.R.ChildTasks[i] = related.R.ChildTasks[ln-1]
		}
		related.R.ChildTasks = related.R.ChildTasks[:ln-1]
		break
	}
	return nil
}
...
func (o *Task) AddProjectTasks(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*ProjectTask) error {
	var err error
...
// AddChildTasks adds the given related objects to the existing relationships
// of the task, optionally inserting them as new records.
// Appends related to o.R.ChildTasks.
// Sets related.R.Child appropriately.
func (o *Task) AddChildTasks(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*Task) error {
	var err error
	for _, rel := range related {
		if insert {
			queries.Assign(&rel.ChildID, o.ID)
			if err = rel.Insert(ctx, exec, boil.Infer()); err != nil {
				return errors.Wrap(err, "failed to insert into foreign table")
			}
		} else {
	...
	if o.R == nil {
		...
		o.R.ChildTasks = append(o.R.ChildTasks, related...)
	}
...
// SetChildTasks removes all previously related items of the
// task replacing them completely with the passed
// in related items, optionally inserting them as new records.
// Sets o.R.Child's ChildTasks accordingly.
// Replaces o.R.ChildTasks with related.
// Sets related.R.Child's ChildTasks accordingly.
func (o *Task) SetChildTasks(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*Task) error {
	query := "update \"tasks\" set \"child_id\" = null where \"child_id\" = $1"
	...
	if o.R != nil {
		for _, rel := range o.R.ChildTasks {
			queries.SetScanner(&rel.ChildID, nil)
			if rel.R == nil {
				continue
			}
	...
	return o.AddChildTasks(ctx, exec, insert, related...)
}

// RemoveChildTasks relationships from objects passed in.
// Removes related items from R.ChildTasks (uses pointer comparison, removal does not keep order)
// Sets related.R.Child.
func (o *Task) RemoveChildTasks(ctx context.Context, exec boil.ContextExecutor, related ...*Task) error {
	if len(related) == 0 {
		return nil
	}
	...
	for _, rel := range related {
		...
		if _, err = rel.Update(ctx, exec, boil.Whitelist("child_id")); err != nil {
			return err
		}
	}
	if o.R == nil {
	...
	for _, rel := range related {
		for i, ri := range o.R.ChildTasks {
			if rel != ri {
				continue
			}

			ln := len(o.R.ChildTasks)
			if ln > 1 && i < ln-1 {
				o.R.ChildTasks[i] = o.R.ChildTasks[ln-1]
			}
			o.R.ChildTasks = o.R.ChildTasks[:ln-1]
			break
		}
	}
